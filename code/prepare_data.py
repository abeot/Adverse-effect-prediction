...
# We only want the drugs for which we have frequency information
# (refer to [this paper](https://www.nature.com/articles/s41467-020-18305-y)). 
# CID is given, and it's easy to get SMILES from that.
